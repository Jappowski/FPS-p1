...
namespace Mirror
{
    ...
    public static class NetworkReaderExtensions
    {
        ...
        public static NetworkIdentity ReadNetworkIdentity(this NetworkReader reader)
        {
            ...
            if (NetworkIdentity.spawned.TryGetValue(netId, out var identity)) return identity;
        ...
        public static NetworkBehaviour.NetworkBehaviourSyncVar ReadNetworkBehaviourSyncVar(this NetworkReader reader)
        {
            ...
            // if netId is not 0, then index is also sent to read before returning
            if (netId != 0) componentIndex = reader.ReadByte();
        ...
        public static List<T> ReadList<T>(this NetworkReader reader)
        {
            ...
            for (var i = 0; i < length; i++) result.Add(reader.Read<T>());
            return result;
        }
        ...
        public static T[] ReadArray<T>(this NetworkReader reader)
        {
            ...
            for (var i = 0; i < length; i++) result[i] = reader.Read<T>();
            return result;
        }
