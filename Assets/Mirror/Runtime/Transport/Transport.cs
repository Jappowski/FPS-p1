...
namespace Mirror
{
    ...
    ///         <item>
    ///             <description>
    ///                 Callbacks can be invoked after <see cref="ServerStop" /> or <see cref="ClientDisconnect" /> as been
    ///                 called
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    ///         <item>
    ///             <description>
    ///                 <see cref="Available" /> should check the platform and 32 vs 64 bit if the transport only works on some
    ///                 of them
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    public abstract class Transport : MonoBehaviour
    {
        ...
        public Action<ArraySegment<byte>, int> OnClientDataReceived =
            (data, channel) => Debug.LogWarning("OnClientDataReceived called with no handler");
        ...
        /// </summary>
        public Action<int, ArraySegment<byte>, int> OnServerDataReceived = (connId, data, channel) =>
        ...
        public Action<int, Exception> OnServerError =
            (connId, error) => Debug.LogWarning("OnServerError called with no handler");
        ...
        public Action<int> OnServerDisconnected =
            connId => Debug.LogWarning("OnServerDisconnected called with no handler");
