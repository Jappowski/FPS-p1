...
namespace Mirror
{
    ...
    public static class Compression
    {
        ...
        public static uint CompressQuaternion(Quaternion q)
        {
            ...
            var largestIndex =
                LargestAbsoluteComponentIndex(new Vector4(q.x, q.y, q.z, q.w), out var _, out var withoutLargest);
        ...
        public static Quaternion DecompressQuaternion(uint data)
        {
            ...
            {
                case 0:
                    value = new Vector4(d, a, b, c);
                    break;
                case 1:
                    value = new Vector4(a, d, b, c);
                    break;
                case 2:
                    value = new Vector4(a, b, d, c);
                    break;
                default:
                    value = new Vector4(a, b, c, d);
                    break;
            }
