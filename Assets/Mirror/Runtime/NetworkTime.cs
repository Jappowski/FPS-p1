...
namespace Mirror
{
    ...
    public static class NetworkTime
    {
        ...
        internal static void OnClientPong(NetworkPongMessage message)
        {
            ...
            var newRtt = now - message.clientTime;
            _rtt.Add(newRtt);
            ...
            var newOffset = now - newRtt * 0.5f - message.serverTime;

            var newOffsetMin = now - newRtt - message.serverTime;
            var newOffsetMax = now - message.serverTime;
