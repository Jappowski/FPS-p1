...
namespace Mirror
{
    ...
    public class NetworkBehaviourInspector : Editor
    {
        ...
        private bool SyncsAnything(Type scriptClass)
        {
            ...
            var syncObjects = (List<SyncObject>) syncObjectsField.GetValue(serializedObject.targetObject);
        ...
        private void OnEnable()
        {
            if (target == null)
            {
                Debug.LogWarning("NetworkBehaviourInspector had no target object");
                return;
            }
    ...
    public class SyncListDrawer
    {
        ...
        public void Draw()
        {
            ...
            for (var i = 0; i < syncListFields.Count; i++) DrawSyncList(syncListFields[i]);
        }
