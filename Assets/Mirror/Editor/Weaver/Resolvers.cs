...
namespace Mirror.Weaver
{
    public static class Resolvers
    {
        public static MethodReference ResolveMethod(TypeReference tr, AssemblyDefinition scriptDef, string name)
        {
            ...
            var method = ResolveMethod(tr, scriptDef, m => m.Name == name);
            if (method == null) Weaver.Error($"Method not found with name {name} in type {tr.Name}", tr);
            return method;
        }

        public static MethodReference ResolveMethod(TypeReference t, AssemblyDefinition scriptDef,
        ...
        public static MethodReference TryResolveMethodInParents(TypeReference tr, AssemblyDefinition scriptDef,
            string name)
        {
